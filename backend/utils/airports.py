...
AIRPORTS: dict[str, dict[str, float | str]] = {
    ...
    # Minnesota regional
    "KLXL": {"lat": 45.9494, "lon": -94.3472, "name": "Little Falls/Morrison County"},
    "KSTC": {"lat": 45.5466, "lon": -94.0599, "name": "St. Cloud Regional"},
    "KAXN": {"lat": 45.8663, "lon": -95.3947, "name": "Alexandria"},
    "KBBB": {"lat": 46.4026, "lon": -94.1364, "name": "Brainerd Lakes Regional"},
    "KGPZ": {"lat": 47.2111, "lon": -93.5098, "name": "Grand Rapids"},
    "KHIB": {"lat": 47.3866, "lon": -92.8390, "name": "Hibbing Range Regional"},
    "KINL": {"lat": 48.5662, "lon": -93.4030, "name": "Falls International"},
    "KOWA": {"lat": 44.1234, "lon": -93.2606, "name": "Owatonna"},
    "KRST": {"lat": 43.9083, "lon": -92.5000, "name": "Rochester International"},
    "KDLH": {"lat": 46.8420, "lon": -92.1936, "name": "Duluth International"},
    "KMKT": {"lat": 44.2216, "lon": -93.9186, "name": "Mankato Regional"},
    "KCFE": {"lat": 45.1590, "lon": -93.8433, "name": "Buffalo Municipal"},
    "KMIC": {"lat": 45.0620, "lon": -93.3539, "name": "Crystal"},
    "KFCM": {"lat": 44.8274, "lon": -93.4571, "name": "Flying Cloud"},
    "KANE": {"lat": 45.1450, "lon": -93.2114, "name": "Anoka County-Blaine"},
    "KLVN": {"lat": 43.6476, "lon": -93.2150, "name": "Airlake"},
    "KPNM": {"lat": 45.5627, "lon": -93.6082, "name": "Princeton Municipal"},
